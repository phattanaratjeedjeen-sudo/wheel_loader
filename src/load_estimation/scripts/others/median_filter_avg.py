...
def main():
    ...
    """
    # --- File Path ---
    csv_file_path = '/home/iwa/wheel_loader_ws/results/csv/multi_weigh_pose1_filtered.csv'
    ...
    # As requested, here are 9 sections. You can adjust these ranges based on your data.
    time_sections = [
        [8, 12], [13, 17], [18, 22],
        [23, 27], [28, 32], [33, 37],
        [38, 42], [43, 47], [48, 52]
